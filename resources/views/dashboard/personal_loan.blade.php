...
<div class="innerpage-banner otherpage text-center">
	<img src="{{ asset('assets/images/personal-loan.png') }}" class="img-fluid" title="" alt="" />
	<div class="site-container">
		<div class="breadcumbs-sec loan-sec">
			<h4><span>Personal Loans</span><br>
Stressed over high interest<br>
on Credit Card dues?</h4>
<p>Avail quick and affordable loans from AnyDay Money</p>
...
<section class="other-sec">
	<div class="site-container flex-none page-descrip">
		<h2>Personal Loan</h2>
		<p>
			Mid-month financial crisis can become a problem in situations where you need to pay school fees, medical emergencies, family functions, unplanned holiday trips or even that luxury item that you wanted to have in your home.
		</p>
		<p>
AnyDay Money loans are specially tailored to meet the needs of salaried individuals and helps you tide over your mid-month planned or unplanned short-term financial needs.
		</p>
	</div>
</section>

<section class="loan-application">
	<h2 class="text-center second-title"><span><strong>Personal Loan’s</strong> Features and benefits</span></h2>
...
<section class="eligibility-personalloan">
	<h2 class="text-center second-title"><span>
		<strong>AnyDay Money Personal Loan </strong> Eligibility Criteria</span></h2>
	<div class="site-container">
