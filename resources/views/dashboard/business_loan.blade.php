...
<div class="innerpage-banner otherpage text-center">
	<img src="{{ asset('assets/images/business-loan.png') }}" class="img-fluid" title="" alt="" />
	<div class="site-container">
		<div class="breadcumbs-sec loan-sec">
			<h4><span>Business Loans</span><br>Need funds to manage<br>
and grow your business?</h4>
<p>Apply for quick business loans </p> 
			<a href="{{ url('apply-now') }}" class="redbtn ragister">Apply Now</a>
		</div>
...
<section class="other-sec">
	<div class="site-container flex-none page-descrip">
		<h2>Business Loan</h2>
		<p>Most small and medium business often need short-term loans to meet their working capital requirements or for business expansion.</p>
<p>
Now getting that much needed business loan is just a click away! Our specially crafted business loans will give your business the boost that is required.</p>
<p>
AnyDay Business Loans removes the hassles involved in traditional loans through a completely digital lending process from application to disbursement thereby helping you grow your business faster.</p>
...
<section class="loan-application">
	<h2 class="text-center second-title"><span><strong>AnyDay Business Loan</strong>  - Features and benefits</span></h2>
...
<section class="eligibility-personalloan businessloan">
	<h2 class="text-center second-title"><span><strong>AnyDay Money Business Loan</strong>  - Eligibility Criteria</span></h2>
	<div class="site-container">
		<ul class="eligibility-points">
			<li>
				<h3>Loan Purpose  </h3>
				<ul class="loan-purpose">
					<li> <span> > </span> <span>Working Capital</span></li>
					<li> <span> > </span> <span>Business Expansion</span></li>
					<li> <span> > </span> <span>Takeover of Existing<br>high cost Loans</span></li>   
				</ul>
			</li>

			<!-- <li>
				<h3>Minimum Business Vintage<br>
Required </h3>
				<p>36 months or</br>above</p>
			</li>

			<li>
				<h3>Minimum Business Turnover<br>Required </h3>
				<p>Rs. 12 Lakh p.a.</p>
			</li> -->
...
<section class="calculater-sec">
	<h2 class="text-center second-title"><span><strong>AnyDay Business Loan </strong> EMI Calculator</span></h2>
...
<section class="download-app">
	<div class="site-container">
		<div class="left-side">
			...
			<div class="app-img">
				<a href="https://play.google.com/store/apps/details?id=in.publicam.advancesalary" target="_blank"><img class="img-fluid" src="images/googleplay.png" title="" alt=""></a>
				<a href="https://apps.apple.com/in/app/anyday-money/id1445823067" target="_blank"><img class="img-fluid" src="images/app-store-img.png" title="" alt=""></a>
			</div>
		</div>
	</div>		
</section>
