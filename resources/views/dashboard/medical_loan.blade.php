...
<div class="innerpage-banner otherpage text-center">
	<img src="{{ asset('assets/images/medicallloan.png') }}" class="img-fluid" title="" alt="" />
	<div class="site-container">
		<div class="breadcumbs-sec loan-sec">
			<h4><span>Medical Loans</span><br>
Sudden medical emergencies?</h4>
<p>Take care of your loved ones while we take care of your financial worries</p>
...
<section class="other-sec">
	<div class="site-container flex-none page-descrip">
		<h2>Medical Loan</h2>
		<p>Emergency situations can be unpredictable and in times of unforeseen medical emergencies, money should never come in way of treatments.<br> Getting hassle free funds should be the priority. </p>
<p>
AnyDay Money Loans for medical emergencies ensures that the financial worries at such difficult times are lifted off your shoulders so that you<br> get all the time in the world to focus on the health and care of your loved ones.</p>
<p>Click the link below to apply and let money be the least of your worries.</p>

	</div>
</section>

<section class="loan-application">
	<h2 class="text-center second-title"><span><strong>AnyDay Medical Loan </strong> - Features and benefits</span></h2>
...
<section class="eligibility-personalloan">
	<h2 class="text-center second-title"><span><strong>AnyDay Money Medical Loan </strong> - Eligibility Criteria</span></h2>
	<div class="site-container">
		<ul class="eligibility-points">
			<li>
				<h3>Eligible </h3>
				<p>Salaried / Non salaried<br> Individuals</p>
			</li>
...
<section class="calculater-sec">
	<h2 class="text-center second-title"><span><strong>AnyDay Medical Loan </strong> EMI Calculator</span></h2>
