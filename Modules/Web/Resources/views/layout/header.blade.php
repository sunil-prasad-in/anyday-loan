<!DOCTYPE html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{url('frontend/css/mycss.css')}}" /> 
    ...
    <header class="main-header " id="navbar">
        <div class="site-container">
            <div class="logo" id="logo">
                <a href="{{url('web')}}" title="Anyday Money"><img src="{{url('frontend/images/anyday-logo.svg')}}" title="Anyday Money" alt="Anyday Money"></a>
            </div>
            <!-- end of logo -->
