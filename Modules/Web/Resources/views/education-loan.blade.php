...
<div class="innerpage-banner otherpage text-center">
    <img src="{{url('frontend/images/education-loan.png')}}" class="img-fluid" title="" alt="" />
    <div class="site-container">
        <div class="breadcumbs-sec loan-sec">
            <h4>
                <span>{{get_page_detail('main_title','product-4')}}</span><br>
                {!!get_page_detail('title','product-4')!!}</h4>
                <p>{{get_page_detail('sub_title','product-4')}}</p>
...
<section class="other-sec">
    <div class="site-container flex-none page-descrip">
        <h2>{{get_page_detail('main_content_title','product-4')}}</h2>
        {!!get_page_detail('main_content','product-4')!!}
    </div>
</section>

<section class="loan-application">
    <h2 class="text-center second-title">
        <span><strong>{{get_page_detail('features_title','product-4')}}</strong> {{get_page_detail('features_title_second','product-4')}}</span>
    </h2>
    ...
    <div class="site-container flex-none">
        <div class="applica-box easy-getloan">
            <div class="appli-inner">
                ...
                <div class="appli-text">
                    <h2>{{get_page_detail('feature_tile_1','product-4')}}</h2>
                    <p>{{get_page_detail('feature_sub_title_1','product-4')}}</p>
                </div>  
            </div>
        </div>
        <div class="applica-box instant-disbursal">
            <div class="appli-inner">
                ...
                <div class="appli-text">
                    <h2>{{get_page_detail('feature_tile_2','product-4')}}</h2>
                    <p>{{get_page_detail('feature_sub_title_2','product-4')}}</p>
                </div>  
            </div>
        </div>
        <div class="applica-box flexible-tenure">
            <div class="appli-inner">
                ...
                <div class="appli-text">
                    <h2>{{get_page_detail('feature_tile_3','product-4')}}</h2>
                    <p>{{get_page_detail('feature_sub_title_3','product-4')}}</p>
                </div>  
            </div>
        </div>
        <div class="applica-box no-partpaymnet">
            <div class="appli-inner">
                ...
                <div class="appli-text">
                    <h2>{{get_page_detail('feature_tile_4','product-4')}}</h2>
                    <p>{{get_page_detail('feature_sub_title_4','product-4')}}</p>
                </div>  
            </div>
        </div>
        <div class="applica-box quick-app-appli">
            <div class="appli-inner">
                ...
                <div class="appli-text">
                    <h2>{{get_page_detail('feature_tile_5','product-4')}}</h2>
                    <p>{{get_page_detail('feature_sub_title_5','product-4')}}</p>
                </div>  
            </div>
        </div>
        <div class="applica-box no-force-closure">
            <div class="appli-inner">
                ...
                <div class="appli-text">
                    <h2>{{get_page_detail('feature_tile_6','product-4')}}</h2>
                    <p>{{get_page_detail('feature_sub_title_6','product-4')}}</p>
                </div>  
            </div>
        </div>
    </div>
...
<section class="eligibility-personalloan">
    ...
    <strong>{{get_page_detail('e_title','product-4')}} </strong> {{get_page_detail('e_title_second','product-4')}}</span></h2>
    <div class="site-container">
        <ul class="eligibility-points">
            <li>
                <h3>{{get_page_detail('content_tile_1','product-4')}}</h3>
                <p>{{get_page_detail('content_sub_title_1','product-4')}}</p>
            </li>

            <li>
                <h3>{{get_page_detail('content_tile_2','product-4')}}</h3>
                <p>{{get_page_detail('content_sub_title_2','product-4')}}</p>
            </li>

            <li>
                <h3>{{get_page_detail('content_tile_3','product-4')}}</h3>
                <p>{{get_page_detail('content_sub_title_3','product-4')}}</p>
            </li>

            <li>
                <h3>{{get_page_detail('content_tile_4','product-4')}}</h3>
                <p>{{get_page_detail('content_sub_title_4','product-4')}}</p>
            </li>
        </ul>
    </div>
</section>
